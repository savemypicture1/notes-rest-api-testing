...
class RestClient:
    ...
    def _patch(self, path, headers=None, expected_status_code=200, **kwargs):
        """
        ...
        url = self.BASE_URL + path
        headers = headers or self._headers
        self._log.info(f"PATCH request to {url}")
    ...
    def _put(self, path, headers=None, expected_status_code=200, **kwargs):
        """
